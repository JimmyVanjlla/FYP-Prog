...
from app.routers import auth, feedback, forecasting, inventory, kitchen, menu, staffing, users, waste
...
app = FastAPI(
    ...
    description=(
        ...
        "Module 8 (Staff Scheduling). Interactive docs at /docs (FastAPI's "
